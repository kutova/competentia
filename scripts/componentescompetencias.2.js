    ...
    <tr>
      ...
      <td class="clicavel">
        <span class="simbolo" 
          ...
          title="Exibe os dados e cursos do componente de competências">
          <img src="./imagens/visibility.svg" />
        </span>
        <span class="simbolo" 
          onclick="editaComponente('${componente.id}')"
          title="Altera os dados do componente de competências">
          <img src="./imagens/edit.svg" />
        </span>
        <span class="simbolo" 
          onclick="removeComponente('${componente.id}')"
          title="Remove o componente de competências deste curso">
      ...
      (cc) => `<tr>
       ...
       <td class="clicavel">
        ...
        cc.observacoes
          ...
          title="Exibe a descrição da competência">
          <img src="./imagens/visibility.svg" />
        </span></td>
       </tr>`
    )
