    ...
    <tr>
      ...
      <td class="clicavel">
        <span class="simbolo" 
          ...
          title="Exibe os dados do componente de competência">
          <img src="./imagens/visibility.svg" />
        </span>
        <span class="simbolo" 
          onclick="editaComponente(${cc.id}, ${competencia.id})"
          title="Altera os dados do componente de competência">
          <img src="./imagens/edit.svg" />
        </span>
        <span class="simbolo" 
          onclick="removeComponente(${cc.id}, ${competencia.id})"
          title="Remove o componente de competência desta competência">
    ...
    <tr>
      ...
      <td class="clicavel">
        <span class="simbolo" 
          ...
          title="Exibe os dados e cursos do componente de competência">
          <img src="./imagens/visibility.svg" />
        </span>
        <span class="simbolo" 
          onclick="importaComponente(${componente.id}, ${idCompetencia})"
          title="Vincula este componente à competência">
